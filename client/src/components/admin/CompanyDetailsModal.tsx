...
const CompanyDetailsModal: React.FC<CompanyDetailsModalProps> = ({
  ...
  // Função para encontrar arquivo no backend pelo nome original
                  ...
                  {company?.integracaoTipo !== "NAO" &&
                    company?.integracaoTipo !== "Não Utilizo" && (
                      <p className="text-orange-200 text-xs mt-2">
                        💡 Todas as configurações necessárias foram fornecidas
                        para a integração funcionar corretamente.
                      </p>
                    )}
                </div>
              </div>
